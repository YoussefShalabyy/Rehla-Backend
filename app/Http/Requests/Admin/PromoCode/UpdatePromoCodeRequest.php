...
class UpdatePromoCodeRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            'code'                => ['sometimes', 'string', Rule::unique('promo_codes', 'code')->ignore($id)],
            'scope_type'          => ['sometimes', 'string', Rule::in(['global', 'listing_type', 'property_type', 'listing'])],
            'scope_value'         => ['nullable', 'string', 'required_unless:scope_type,global'],
            'discount_type'       => ['sometimes', 'string', Rule::enum(DiscountType::class)],
